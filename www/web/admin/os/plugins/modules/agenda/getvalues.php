<?php
	...
	if(trim($_REQUEST['query'])==""){
		$sqlquery="SELECT ".$field." as field FROM agenda GROUP BY ".$field." ORDER BY ".$field;	
	}else{
		$sqlquery="SELECT ".$field." as field FROM agenda WHERE ".$field." like '".$query."%' GROUP BY ".$field." ORDER BY ".$field;
	}
