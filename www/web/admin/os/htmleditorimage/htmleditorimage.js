...
Ext.ux.HTMLEditorImage = function() {
  ...
  var createImage = function() {
    ...
    if(tabs.form.findField('alignement').getValue()!="")
    	element.align = tabs.form.findField('alignement').getValue();
            ...
            items: [{
              ...
              allowBlank: false,
            	...
            	onTriggerClick: function() {
              	if (!imageBrowser) {
	              	if(Ext.chewingCom.frontAdmin){
	              		imageBrowser = new Ext.ux.ImageBrowser({	
			            	width: 514,
		              		height: 321,
		              		rootpath:Ext.chewingCom.Browserrootpath,
							listURL: 'admin/os/htmleditorimage/listimages.php',
							uploadURL: 'admin/os/htmleditorimage/uploadimage.php',
							deleteURL: 'admin/os/htmleditorimage/deleteimage.php',
                ...
                items: [{
                  ...
                  checked: false,
			        ...
			        ,store: new Ext.data.SimpleStore({
				            fields: ['value', 'text'],
				            data: [['','none'],['left','Gauche'],['right','Droite'],['middle','Middle'],['absmiddle','Middle Abs']]
				    })
				    ,editable:false
			        ,valueField: 'value'
				    ,displayField: 'text'
    		...
    		listeners: {
    			'show': function() {
					...
					if (element) {
						...
						tabs.form.findField('constrain').setValue(true);
						if(element.align)
							tabs.form.findField('alignement').setValue(element.align);
